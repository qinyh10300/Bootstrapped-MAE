...
# Output log file
log_file = "./hyperparam_results/pretrain_bootstrap_steps_tuning.log"
...
def run_training(bootstrap_steps, use_ema):
    ...
    output_dir = f"../ckpts/mae_baseline/pretrain_bootstrap_steps_{bootstrap_steps}_use_ema_{use_ema}"
